        ...
        <div className="row">
            ...
            <div className="card mb-4">
              ...
              <div className="card-body">
                <h5 className="card-title">
                  Nova Chegada 1 - Inovação no Mercado
                </h5>
                <p className="card-text">
                  Acabamos de lançar Hambúrguer pimentado, não perca a chance de
                  conhecer mais!
                </p>
              </div>
            </div>
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              ...
              <div className="card-body">
                <h5 className="card-title">
                  Nova Chegada 2 - O Futuro Está Aqui
                </h5>
                <p className="card-text">
                  Este é o produto do futuro! Conheça a nova tendência de
                  tecnologia em nossa loja.
                </p>
              </div>
            </div>
          </div>
